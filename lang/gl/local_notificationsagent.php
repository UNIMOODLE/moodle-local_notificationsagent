...
$string['evaluaterule_help'] = 'A regra avalíase do seguinte xeito: ([Condición 1] **AND** [Condición 2] **AND** ... ) **AND NOT** ([Excepción 1] **OU** [Excepción 2] ...) -> [Acción 1]->[Acción 2 ]';
...
$string['privacy:metadata:notificationsagentreport'] = 'Rexistra as mensaxes enviadas aos usuarios que poden conter algúns datos do usuario.';
