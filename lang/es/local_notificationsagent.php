...
$string['disable_user_use'] = 'Deshabilitar para los usuarios tipo estudiante';
$string['disable_user_use_desc'] = 'Deshabilitar el uso del Agente de notificaciones para los usuarios tipo estudiante, los que no tienen el permiso "local/notificationsagent:managecourserule"';
...
$string['evaluaterule_help'] = 'La regla se evalúa como sigue: ([Condtion 1] **AND** [Condition 2] **AND** ...) **AND NOT** ([Exception 1] OR [Exception 2] ...) -> [Action 1]->[Action 2]';
...
$string['privacy:metadata:notificationsagentreport'] = 'Registra los mensajes enviados a los usuarios que puedan contener algún dato del usuario';
...
$string['rulesaved_rebuildqueued'] = 'Regla guardada. La programación de notificaciones se completará en segundo plano.';
...
$string['taskrebuildtriggers'] = 'Reconstruir disparadores de reglas de notificación';
