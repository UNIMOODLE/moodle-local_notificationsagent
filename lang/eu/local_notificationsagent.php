...
$string['evaluaterule_help'] = 'Araua honela ebaluatzen da: ([1 Baldintza] **ETA** [2. Baldintza] **ETA** ... ) **ETA EZ** ([1. Salbuespena] **OR** [2. Salbuespena] ...) -> [1. Ekintza]->[2. Ekintza ]';
...
$string['privacy:metadata:notificationsagentreport'] = 'Erabiltzaileei bidalitako mezuak erregistratzen ditu, erabiltzailearen datu batzuk eduki ditzaketenak.';
