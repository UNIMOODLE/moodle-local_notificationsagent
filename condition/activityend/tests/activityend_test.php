...
class activityend_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        self::$subplugin = new activityend(self::$rule);
    ...
    public function test_evaluate($timeaccess, $usecache, $param, $complementary, $expected) {
        ...
        if ($usecache) {
            ...
            $objdb->timestart = self::$cmtestae->timeclose - $params['time'];
    ...
    public function test_convertparameters() {
        $params = [
            "5_activityend_days" => "1",
            "5_activityend_hours" => "0",
            "5_activityend_minutes" => "0",
            "5_activityend_seconds" => "1",
            "5_activityend_cmid" => "7",
        ];
