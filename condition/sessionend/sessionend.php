...
class notificationsagent_condition_sessionend extends notification_activityconditionplugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'notificationscondition_sessionend');
    }
