...
namespace notificationscondition_activitynewcontent\task;
...
class activitynewcontent_crontask extends scheduled_task {
    ...
    public function get_name() {
        return get_string('activitynewcontent_crontask', 'notificationscondition_activitynewcontent');
    }
    ...
    public function execute() {
        ...
        foreach ($conditions as $condition) {
            ...
            $results = notificationsagent_condition_activitynewcontent_get_cm_endtime($cmid);
