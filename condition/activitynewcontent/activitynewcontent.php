...
class notificationsagent_condition_activitynewcontent extends notification_activityconditionplugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'notificationscondition_activitynewcontent');
    }
    ...
    public function get_ui($mform, $id, $courseid, $exception) {
        ...
        $mform->addElement(
            ...
            get_string(
                'editrule_condition_activity', 'notificationscondition_activitynewcontent',
                ['typeelement' => '[AAAA]']
            ),
            $listactivities
        );
