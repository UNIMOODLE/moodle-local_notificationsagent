...
$string['pluginname'] = 'The condition of the activity has new content.';
$string['conditiontext'] = 'There is new content in the activity [AAAA] . ';
...
$string['activitynewcontent_crontask'] = 'Activity end cron task';
