 ...
 * weekdays cron task
 */
class weekdays_crontask extends scheduled_task {
    ...
    public function get_name() {
        return get_string('weekdays_crontask', 'notificationscondition_weekdays');
    }
    ...
    public function execute() {
        ...
        foreach ($conditions as $condition) {
            ...
            $subplugin = new weekdays($condition->ruleid, $condition->id);
