...
$string['conditiontext'] = 'Han pasado [TTTT] desde la última entrada del estudiante en la actividad [AAAA].';
...
$string['pluginname'] = 'Condición de fecha desde la última entrada del estudiante en la actividad';
