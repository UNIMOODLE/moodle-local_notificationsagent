...
class notificationsagent_condition_calendareventto extends notification_activityconditionplugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'notificationscondition_calendareventto');
    }
    ...
    public function evaluate(EvaluationContext $context): bool {
        ...
        ($timeaccess > $timestart) && ($timeaccess < $event[$params->calendar]->timestart) ? $meetcondition = true
            : $meetcondition = false;
    ...
    public function convert_parameters($params) {
        ...
        return json_encode(['time' => $timeinseconds, 'calendar' => (int) $calendar]);
    }
