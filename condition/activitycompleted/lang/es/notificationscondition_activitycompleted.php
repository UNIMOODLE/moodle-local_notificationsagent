...
$string['pluginname'] = 'Condición relativa a una actividad completada';
$string['conditiontext'] = 'El usuario tiene completada la actividad [AAAA].';
...
$string['activitycompleted_crontask'] = 'activitycompleted cron task';
