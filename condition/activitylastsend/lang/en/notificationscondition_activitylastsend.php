...
$string['pluginname'] = 'Condition relative date since the last student content submission in the activity';
...
$string['activitylastsend_crontask'] = 'Activiy end cron task';
