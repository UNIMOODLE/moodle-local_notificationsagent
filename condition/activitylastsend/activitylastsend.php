...
class notificationsagent_condition_activitylastsend extends notification_activityconditionplugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'notificationscondition_activitylastsend');
    }
    ...
    public function get_ui($mform, $id, $courseid, $exception) {
        ...
        $mform->addElement(
            ...
            get_string(
                'editrule_condition_activity', 'notificationscondition_activitylastsend',
                ['typeelement' => '[AAAA]']
            ),
            $listactivities
        );
