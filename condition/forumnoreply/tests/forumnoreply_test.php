...
class forumnoreply_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        self::$subplugin = new forumnoreply(self::$rule);
    ...
    public function test_convertparameters() {
        $params = [
            "5_forumnoreply_days" => "1",
            "5_forumnoreply_hours" => "0",
            "5_forumnoreply_minutes" => "0",
            "5_forumnoreply_seconds" => "1",
            "5_forumnoreply_cmid" => "7",
        ];
