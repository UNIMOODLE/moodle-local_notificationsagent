...
class notificationsagent_condition_activityavailable extends notification_activityconditionplugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'notificationscondition_activityavailable');
    }
