...
namespace notificationsaction_removeusergroup\event;

/**
 * Event triggered when conditions are fullfiled and action is notification to particular user.
 */
class notificationsagent_removeusergroup_event extends \core\event\base {
    /**
     * @inheritDoc
     */
    ...
    public static function get_name() {
        return "remove_user_group_event";
    }
    ...
    public function get_description() {
        // TODO.
        return "Group: '$this->groupid' " . " userid: " . $this->userid;
    }
